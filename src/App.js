  ...
  React.useEffect(
    () => {
      ...
      if (window.walletConnection.isSignedIn()) {
        ...
        window.contract
          .get_deposit({ account_id: window.accountId })
      ...
      <main>
        ...
        >
          <fieldset id="fieldset">
            ...
            >
              This app is stored on the NEAR blockchain and allows you to
              deposit and donate tokens to a specific artist or cause.
            </label>
